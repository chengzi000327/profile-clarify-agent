...
| --- | --- | --- | --- |
| 用人经理 | 创建岗位会话；确认招聘原因、成功标准、岗位画像、评估方案和对外 JD；提供候选人反馈；处理Agent发起的画像校准任务 | 确认业务准确性；对校准建议选择接受修改、拒绝修改或继续观察；把已确认 JD 交给 HR 发布 | 查看 HR 内部检索式、渠道策略、人才供给备注和未授权候选人数据；代替 HR 发布 |
| HR 招聘负责人 | 同步约束；查看内部招聘画像；执行寻源和初筛；导入候选人；审核招聘执行类校准信号；发布已确认 JD | 确认招聘可执行性；将招聘信号标记为有效、驳回或继续观察；提出画像调整建议 | 代替用人经理确认业务成功标准或画像变更；未经确认修改正式画像 |
